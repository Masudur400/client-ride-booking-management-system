...
export default function HomeCard() {
  ...
  return (
    <div className="my-5 relative h-[500px] w-full flex items-center justify-center overflow-hidden"> 
      {/* Background Image */}
      <img
        src={homeBg}
        alt="Background"
      ...
      >
        ...
        {
          user
            ? <Button className="border-2">Get Start</Button>
            : <Link to='/login'><Button className="border-2">Get Start</Button></Link>
        }
      </motion.div>
    </div>
  )
