...
import { DriverPostStatusUpdateModal } from "@/components/modules/DriverPostStatusUpdateModal";

const searchSchema = z.object({
    search: z.string(),
});
const DriveOversight = () => {
    ...
    return (
        <div>
            ...
            <div className="my-5">
                <CardTitle className="flex items-center"><span className="mr-2"> ||</span> <span>All Driver Posts</span></CardTitle>
            </div>
            <Table>
                <TableHeader>
                    <TableRow>
                ...
                <TableBody>
                    {
                        driverPosts?.map((item: IPost, idx: string) => <TableRow key={idx}>
                            ...
                            <TableCell className="flex justify-end">
                                ...
                                <DriverPostStatusUpdateModal id={item?._id}></DriverPostStatusUpdateModal>
